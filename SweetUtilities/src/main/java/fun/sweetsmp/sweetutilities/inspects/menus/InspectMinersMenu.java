...
public class InspectMinersMenu extends Menu {
    ...
    public InspectMinersMenu(PlayerMenuUtility playerMenuUtility) {
        super(playerMenuUtility);

        for(Player player : players){
            if(player.getLocation().getBlockY() > core.getInspectManager().getConfig().getInt("miners.y")){
                continue;
            }
